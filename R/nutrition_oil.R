...
Mazola_corn_oil <- function() new(
  ...
  brand = 'Mazola', name = '\u7389\u7c73\u6cb9 Corn\U0001f33d Oil',
...
Kadoya_sesameOil <- function() new(
  Class = 'nutrition', 
  brand = styleURL(text_ = 'Kadoya\u52a0\u767b\u5c4b\u88fd\u6cb9\u6240\U0001f1ef\U0001f1f5', 
...
YouJia_greenPeppercornOil <- function() new(
  Class = 'nutrition',
  brand = styleURL(text_ = '\u53cb\u52a0\U0001f1e8\U0001f1f3', 
...
Morrell_lard <- function() new(
  ...
  brand = 'John Morrell\U0001f1fa\U0001f1f8', name = '\u732a\u6cb9 Lard',
