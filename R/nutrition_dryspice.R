...
McCormick_creamTartar <- function() new(
  ...
  brand = 'McCormick\U0001f1fa\U0001f1f8', name = 'Cream of Tartar',
...
McCormick_garlic_powder <- function() new(
  ...
  name = '\u849c\u7c89 Garlic\U0001f9c4 Powder', 
...
McCormick_onion_powder <- function() new(
  ...
  name = '\u6d0b\u8471\u7c89 Onion\U0001f9c5 Powder',
...
McCormick_ginger <- function() new(
  ...
  name = '\u59dc\u7c89 Ginger\U0001fada, Ground',
  servingGram = 1,
  servingTbsp = 1 #??
)
...
McCormick_oldBay_lowSodium <- function() new(
  ...
  brand = 'McCormick\U0001f1fa\U0001f1f8', name = '\u9a6c\u91cc\u5170\u6d77\u9c9c\u814c\u6599(\u4f4e\u76d0) Old Bay, Less Sodium',
...
McCormick_whitePepper <- function() new(
  ...
  brand = 'McCormick Gourmet\U0001f1fa\U0001f1f8', name = '\u767d\u80e1\u6912\u7c89 Organic White Pepper',
...
SpiceIslands_cumin <- function() new(
  Class = 'nutrition',
  brand = 'Spice Islands\U0001f1fa\U0001f1f8', name = '\u5b5c\u7136\u7c89 Cumin Seed',
...
fourC_panko_seasoned <- function() new(
  ...
  brand = '4C\U0001f1fa\U0001f1f8', name = 'Seasoned Panko Bread Crumbs',
...
fourC_panko <- function() new(
  ...
  brand = '4C\U0001f1fa\U0001f1f8', name = 'Plain Panko Bread Crumbs',
...
SimplyOrganic_Southwest <- function() new(
  ...
  brand = 'Simply Organic\U0001f1fa\U0001f1f8', name = 'Southwest Seasoning',
  servingGram = .6, 
...
SimplyOrganic_ginger <- function() new(
  ...
  name = '\u59dc\u7c89 Ginger\U0001fada Root, Ground',
...
Chinata_paprika <- function() new(
  ...
  brand = 'La Chinata\U0001f1ea\U0001f1f8', name = '\u7ea2\u751c\u6912\u7c89 Sweet Smoked Paprika\U0001f336', 
