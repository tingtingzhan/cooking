...
Runamok_Bourbon <- function() new(
  ...
  name = '\u9152\u6876\u67ab\u7cd6\u6d46 Bourbon Barrel-Aged Maple\U0001f341 Syrup',
...
Runamok_rum <- function() new(
  ...
  name = '\u9152\u6876\u67ab\u7cd6\u6d46 Rum Barrel-Aged Maple\U0001f341 Syrup',
  # full bottle 690g
...
Runamok_ryeWhisky <- function() new(
  ...
  name = '\u9152\u6876\u67ab\u7cd6\u6d46 WhistlePig Rye Whiskey Barrel-Aged Maple\U0001f341 Syrup',
  # full bottle 948g
...
Runamok_brandy <- function() new(
  ...
  name = '\u9152\u6876\u67ab\u7cd6\u6d46 Apple Brandy Barrel-Aged Maple\U0001f341 Syrup',
  # full bottle 675g; 
  servingGram = 40, serving_ml = 30,
