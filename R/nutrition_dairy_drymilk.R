...
Meyenberg_goat_drymilk <- function() new(
  ...
  name = '\u8131\u8102\u7f8a\u5976\u7c89 Nonfat Dry Goat\U0001f410 Milk', 
...
Meyenberg_goatWhole_drymilk <- function() new(
  ...
  name = '\u5168\u8102\u7f8a\u5976\u7c89 Whole Dry Goat\U0001f410 Milk', 
...
Carnation_drymilk <- function() new(
  ...
  brand = styleURL(text_ = 'Nestl\u00e9 Carnation\U0001f1fa\U0001f1f8', 
                   url_ = 'www.nestleprofessional.us/nestle-carnation-nonfat-dry-milk-4-x-2275-oz'),
...
Carnation_whole_drymilk <- function() new(
  ...
  brand = 'Nestl\u00e9 Carnation\U0001f1fa\U0001f1f8', 
...
Horizon_whole_drymilk <- function() new(
  Class = 'nutrition', 
  brand = styleURL(text_ = 'Horizon\U0001f1fa\U0001f1f8', 
                   url_ = 'horizon.com/organic-dairy-products/organic-milk/organic-dry-whole-milk/'),
  name = '\u5168\u8102\u5976\u7c89 Dry Whole Milk',
